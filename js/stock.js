...
function renderStockList() {
  ...
  const barcode = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="hsl(220,80%,50%)" stroke-width="2"><path d="M3 3h5l1.5 1.5M3 3v5"/><rect x="9" y="3" width="4" height="1"/><rect x="15" y="3" width="4" height="1"/><path d="M21 3h-2"/><path d="M21 3v5"/><rect x="3" y="9" width="1" height="4"/><rect x="3" y="15" width="1" height="4"/><path d="M3 21v-2"/><path d="M3 21h5"/><rect x="9" y="21" width="4" height="1" transform="rotate(180 11 21.5)"/></svg>`;
